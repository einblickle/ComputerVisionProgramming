...
image = cv2.imread(r'D:\valentin\HochschuleEsslingen\Repositories\ComputerVision\Fotos\Logo_HE.png', cv2.IMREAD_GRAYSCALE)
...
cv2.imwrite(r'D:\valentin\HochschuleEsslingen\Repositories\ComputerVision\Fotos\whatIsThat.png', image_clip)